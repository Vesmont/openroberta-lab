...
Blockly.Blocks['procedures_defnoreturn'] = {
	...
	customContextMenu: function(options) {
		...
		(option as any).text = Blockly.Msg['PROCEDURES_CREATE_DO'].replace('%1', name);
		...
		(option as any).callback = Blockly.ContextMenu.callbackFactory(this, xmlBlock);
		(options as any).push(option);
		...
		if (!this.isCollapsed()) {
			for (var i = 0; i < this.argumentVarModels_.length; i++) {
				...
				(argOption as any).text = Blockly.Msg['VARIABLES_SET_CREATE_GET']
				...
				(argOption as any).callback =
					Blockly.ContextMenu.callbackFactory(this, argXmlBlock);
				(options as any).push((argOption as any));
			}
		}
	},
...
Blockly.Blocks['procedures_defreturn'] = {
	...
	setStatements_: (Blockly.Blocks['procedures_defnoreturn'] as any).setStatements_,
	updateParams_: (Blockly.Blocks['procedures_defnoreturn'] as any).updateParams_,
	mutationToDom: (Blockly.Blocks['procedures_defnoreturn'] as any).mutationToDom,
	domToMutation: (Blockly.Blocks['procedures_defnoreturn'] as any).domToMutation,
	/**
	 * Return the signature of this procedure definition.
	 * @return {!Array} Tuple containing three elements:
	 *     - the name of the defined procedure,
	...
	getVars: (Blockly.Blocks['procedures_defnoreturn'] as any).getVars,
	getVarModels: (Blockly.Blocks['procedures_defnoreturn'] as any).getVarModels,
	renameVarById: (Blockly.Blocks['procedures_defnoreturn'] as any).renameVarById,
	updateVarName: (Blockly.Blocks['procedures_defnoreturn'] as any).updateVarName,
	displayRenamedVar_: (Blockly.Blocks['procedures_defnoreturn'] as any).displayRenamedVar_,
	customContextMenu: (Blockly.Blocks['procedures_defnoreturn'] as any).customContextMenu,
...
Blockly.Blocks['procedures_callnoreturn'] = {
	...
	setProcedureParameters_: function(paramNames, paramIds) {
		...
		var defBlock = Blockly.Procedures.getDefinition(this.getProcedureCall(),
			this.workspace);
		var mutatorOpen = defBlock && (defBlock as any).mutator &&
			(defBlock as any).mutator.isVisible();
		if (!mutatorOpen) {
			this.quarkConnections_ = {};
			this.quarkIds_ = null;
		}
	...
	customContextMenu: function(options) {
		...
		var option = { enabled: true };
		(option as any).text = Blockly.Msg['PROCEDURES_HIGHLIGHT_DEF'];
		var name = this.getProcedureCall();
		var workspace = this.workspace;
		(option as any).callback = function() {
...
Blockly.Blocks['procedures_callreturn'] = {
	...
	getProcedureCall: (Blockly.Blocks['procedures_callnoreturn'] as any).getProcedureCall,
	renameProcedure: (Blockly.Blocks['procedures_callnoreturn'] as any).renameProcedure,
	setProcedureParameters_:
		(Blockly.Blocks['procedures_callnoreturn'] as any).setProcedureParameters_,
	updateShape_: (Blockly.Blocks['procedures_callnoreturn'] as any).updateShape_,
	mutationToDom: (Blockly.Blocks['procedures_callnoreturn'] as any).mutationToDom,
	domToMutation: (Blockly.Blocks['procedures_callnoreturn'] as any).domToMutation,
	getVars: (Blockly.Blocks['procedures_callnoreturn'] as any).getVars,
	getVarModels: (Blockly.Blocks['procedures_callnoreturn'] as any).getVarModels,
	onchange: (Blockly.Blocks['procedures_callnoreturn'] as any).onchange,
	customContextMenu:
		(Blockly.Blocks['procedures_callnoreturn'] as any).customContextMenu,
